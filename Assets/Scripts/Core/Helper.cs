...
public struct Helper
{
    ...
    public static bool CheckBit(ulong a, ulong b, int index) =>
        GetBit(a, index) == GetBit(b, index);
    ...
    // Returns the opponents side enum, provided the player's enum
    public static Side GetOpponent(Side side) => side == Side.White ? Side.Black : Side.White;

    //======================================== Input ========================================//
    // Places the inputted piece on the given square
    public static void PlacePiece(Board board, Piece piece, Square square) =>
        SetBit(ref board.Bitboards[(int)piece], (int)square);
